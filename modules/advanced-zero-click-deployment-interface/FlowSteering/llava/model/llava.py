...
class LlavaLlamaModel(LlamaModel):
    ...
    def forward(
        ...
        if vision_tower is not None and (input_ids.shape[1] != 1 or self.training) and images is not None:
            ...
            # print(f'Image feature: {image_features.shape}')
            ...
            for cur_input_ids, cur_input_embeds in zip(input_ids, inputs_embeds):
                ...
                if vision_tower.config.use_im_start_end:
                    ...
                    # Use the line below to decide the input concat text or not
                    # cur_new_input_embeds = cur_image_features
                    ...
                    # print(f'mask_index_start: ', mask_index_start)
        ...
        res = super(LlavaLlamaModel, self).forward(
